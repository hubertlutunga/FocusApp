...
final class Quote extends Model
{
    ...
    public function createWithItems(array $header, array $items): int
    {
        ...
        try {
            $statement = $this->db->prepare('INSERT INTO quotes (client_id, quote_number, quote_date, valid_until, status, currency_code, subtotal, discount_amount, tax_rate, tax_amount, grand_total, notes, created_by, deleted_at, created_at, updated_at)
                VALUES (:client_id, :quote_number, :quote_date, :valid_until, :status, :currency_code, :subtotal, :discount_amount, :tax_rate, :tax_amount, :grand_total, :notes, :created_by, NULL, NOW(), NOW())');
