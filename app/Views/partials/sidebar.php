...
$pilotagePaths = ['/expenses', '/expenses/create', '/expenses/show', '/expenses/edit', '/starlink-subscriptions', '/starlink-subscriptions/create', '/starlink-subscriptions/edit', '/reports'];
        ...
        <div class="sidebar-group">
            ...
            <div class="collapse <?= $pilotageOpen ? 'show' : '' ?>" id="sidebar-pilotage">
                <div class="sidebar-subnav">
                    ...
                    <a class="nav-link <?= is_active_path(['/starlink-subscriptions','/starlink-subscriptions/create','/starlink-subscriptions/edit']); ?>" href="<?= e(url('/starlink-subscriptions')); ?>"><i class="bi bi-router"></i><span>Abonnements Starlink</span></a>
