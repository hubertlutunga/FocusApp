...
DROP TABLE IF EXISTS starlink_subscriptions;
...
CREATE TABLE starlink_subscriptions (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    client_id BIGINT UNSIGNED NOT NULL,
    ...
    INDEX idx_starlink_subscriptions_end_date (end_date),
    INDEX idx_starlink_subscriptions_status (status)
) ENGINE=InnoDB;
